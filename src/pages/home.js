            ...
            <div className="product-slot">
                <Grid container>
                    <Grid container>
                        <Grid container alignItems="flex-start" xs={12} sm={6} className="product-box1 item">
                            ...
                            <Grid item xs={6} className="ph-x1 pv-x1 lg-ph-x0p25 lg-pv-x0p25">
                                <Link to="/shop">
                                    <p className="text-x4 lg-text-x3 text-medium lg-mb-x1 mb-x1 lg-mb-x1">Smart watches for every fitness level</p>
                        ...
                        <Grid container alignItems="flex-start" xs={12} sm={6} className="product-box2 item">
                            <Grid item xs={6}>
                                <Link to="/shop">
                                    <img src={productTwo} className="width-full" alt="smart watch"/>
                                </Link>
                            </Grid>
                            <Grid item xs={6} className="ph-x1 pv-x1 lg-ph-x0p25 lg-pv-x0p25">
                                <Link to="/shop">
                                    <p className="text-x4 lg-text-x3 text-medium lg-mb-x1 mb-x1 lg-mb-x1">Trackers for a healthy lifestyle</p>
                                    <p className="flex-align-center text-x2 lg-text-x2 text-medium">Shop now <ArrowRightAltIcon /></p>
                                </Link>
                            </Grid>
                        </Grid>
                    ...
                    <Grid container className="second-row">
                        ...
                        <Grid container alignItems="flex-start" xs={12} sm={6} className="product-box2 item">
                            <Grid item xs={6}>
                                <Link ><img src={productTwo} className="width-full" alt="smart watch"/></Link>
                            </Grid>
                            <Grid item xs={6} className="ph-x1 pv-x1 lg-ph-x0p25 lg-pv-x0p25">
                                <Link>
                                    <p className="text-x4 lg-text-x3 text-medium lg-mb-x1 mb-x1 lg-mb-x1">Trackers for a healthy lifestyle</p>
